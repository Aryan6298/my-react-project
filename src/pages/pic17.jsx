...
import aboutImg1 from '../assets/gallery15.jpg';
  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h2 className="about-heading">Installed Borewell Monitoring and Flow Meter System</h2>
        ...
        <div className="row align-items-center" data-aos="fade-up">
          ...
          <div className="col-md-6">
            <h3 className="section-heading" data-aos="fade-right">About Installed Borewell Monitoring and Flow Meter System</h3>

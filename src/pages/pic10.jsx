...
import aboutImg1 from '../assets/gallery01.jpg';
  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h2 className="about-heading">Wall-Mounted Aquifer Injection Setup</h2>
        ...
        <div className="row align-items-center" data-aos="fade-up">
          ...
          <div className="col-md-6">
            <h3 className="section-heading" data-aos="fade-right">About Wall-Mounted Aquifer Injection Setup</h3>

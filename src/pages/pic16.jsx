...
import aboutImg1 from '../assets/gallery14.jpg';
  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h2 className="about-heading">GPS-based Groundwater Survey with Data Logging</h2>
        ...
        <div className="row align-items-center" data-aos="fade-up">
          ...
          <div className="col-md-6">
            <h3 className="section-heading" data-aos="fade-right">About GPS-based Groundwater Survey with Data Logging</h3>

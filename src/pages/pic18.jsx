...
import aboutImg1 from '../assets/gallery16.jpg';
  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h2 className="about-heading">Borewell Drilling Operation Supervision</h2>
        ...
        <div className="row align-items-center" data-aos="fade-up">
          ...
          <div className="col-md-6">
            <h3 className="section-heading" data-aos="fade-right">About Borewell Drilling Operation Supervision</h3>

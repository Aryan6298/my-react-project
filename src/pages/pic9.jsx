...
import aboutImg1 from '../assets/gallery02.jpg';
  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h2 className="about-heading">Building-Integrated Recharge Piping System</h2>
        ...
        <div className="row align-items-center" data-aos="fade-up">
          ...
          <div className="col-md-6">
            <h3 className="section-heading" data-aos="fade-right">About Building-Integrated Recharge Piping System </h3>

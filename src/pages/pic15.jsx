...
import aboutImg1 from '../assets/gallery13.jpg';
  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h2 className="about-heading">Drilling Rig Setup for Borewell Installation</h2>
        ...
        <div className="row align-items-center" data-aos="fade-up">
          ...
          <div className="col-md-6">
            <h3 className="section-heading" data-aos="fade-right">About Drilling Rig Setup for Borewell Installation </h3>
